...
class pulseModSelector(Tkinter.Frame):
  ...
  def __init__(self, root, pulsefit):
    ...
    Tkinter.Label(self, text="tMax").grid(row=1,column=1)
    Tkinter.Label(self, text="c").grid(row=1,column=2)
    Tkinter.Label(self, text="r").grid(row=1,column=3)
    Tkinter.Label(self, text="d").grid(row=1,column=4)
    ...
    # Lables and entry for the starting parameters for the KRL pulse model 
    Tkinter.Label(self, text="ts").grid(row=5,column=1)
    Tkinter.Label(self, text="A").grid(row=5,column=2)
    Tkinter.Label(self, text="tr").grid(row=5,column=3)
    Tkinter.Label(self, text="td").grid(row=5,column=4)
  ...
  def GetPulseMod(self):
   ...
   # print map(lambda x: x.get(),tmp1[0])
